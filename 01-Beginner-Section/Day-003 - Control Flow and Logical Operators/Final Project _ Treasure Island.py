...
choice = choice.lower()
if choice == "left":
  choice = input("You come to a lake. There is an island in the middle of the lake. Type 'Swim'to swim across or type 'Wait' to wait for a boat.\n")
  choice = choice.lower()
  if choice == "wait":
    ...
    print("You got attched by trout. Game Over.")
else:
